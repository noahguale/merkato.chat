...
export const ChatInput = ({
	...
	const sidebarWidth = state === 'collapsed' ? 64 : 280
	const contentWidth = `calc(100vw - ${sidebarWidth}px)`
	const leftOffset = `calc(${sidebarWidth}px + (100vw - ${sidebarWidth}px - min(64rem, 100vw - ${sidebarWidth}px)) / 2)`

	return (
		<AIInput
			className="fixed bottom-0 mb-8 px-4 z-[100] bg-background/95 backdrop-blur-sm border-t shadow-lg "
			// style={{
			// 	width: contentWidth,
			// 	left: leftOffset,
			// }}
