...
function SidebarRail({ className, ...props }: SidebarRailProps) {
	...
	return (
		<button
			...
			{...props}
		>
			<div className="absolute z-10 size-2 rotate-45 rounded-[1px] border border-blue-200 dark:border-blue-300/25 bg-white dark:bg-black top-[2px] right-[-4.5px]" />
			<div className="absolute z-10 size-2 rotate-45 rounded-[1px] border border-blue-200 dark:border-blue-300/25 bg-white dark:bg-black bottom-[2px] right-[-4.5px]" />
		</button>
	)
}
