			...
			return result.toDataStreamResponse({
				...
				getErrorMessage: (error: unknown) => {
					...
					const errorMessages: Record<string, string> = {
						'401':
							'Error with API key. Either invalid or expired. Please update your API key in settings.',
						Unauthorized:
							'Error with API key. Either invalid or expired. Please update your API key in settings.',
						'403':
						...
						Forbidden:
							'Error with API key permissions. Please check your API key has the required permissions.',
						'429':
							'Rate limit exceeded. Please try again later or check your API usage.',
						'rate limit':
							'Rate limit exceeded. Please try again later or check your API usage.',
						insufficient_quota:
							'API quota exceeded. Please check your account usage and billing.',
						quota:
							'API quota exceeded. Please check your account usage and billing.',
					}
