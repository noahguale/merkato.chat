							...
							>
								<TabsList className="grid w-full grid-cols-4 ">
									...
									<TabsTrigger value="anthropic">
										<Anthropic className="w-4 h-4 fill-white dark:fill-black" />
									</TabsTrigger>
									<TabsTrigger value="openai">
										<OpenAI className="w-4 h-4 fill-white dark:fill-black" />
									</TabsTrigger>
									<TabsTrigger value="openrouter">
										<OpenRouter className="w-4 h-4 fill-white dark:fill-black" />
									</TabsTrigger>
								</TabsList>
