...
export function ChatSidebar() {
	...
	return (
		<Sidebar collapsible="icon" className="relative">
			{/* Corner decorations */}
			<div className="absolute z-10 size-2 rotate-45 rounded-[1px] border border-blue-200 dark:border-blue-300/25 bg-white dark:bg-black top-[-4.5px] left-0" />
			<div className="absolute z-10 size-2 rotate-45 rounded-[1px] border border-blue-200 dark:border-blue-300/25 bg-white dark:bg-black top-[-4.5px] right-0" />
