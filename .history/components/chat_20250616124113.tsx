...
export const Chat = ({ threadId, initialMessages }: ChatProps) => {
	...
	return (
		<div className="relative flex flex-col  max-w-4xl pt-10 mx-auto size-full">
			{/* <div className="flex justify-center items-start min-h-full px-4">
				<ChatMessage messages={messages} />
			</div> */}
			{/* <AIConversation>
				<AIConversationContent className="flex flex-col justify-center items-start min-h-full px-4">
