...
const StyledSection = ({ children }: { children: React.ReactNode }) => {
	return (
		<section
			className="relative px-4 pt-20 pb-[12rem] sm:px-6 sm:pt-28 md:pb-[10.9rem] bg-linear-to-t from-blue-100/20 dark:from-blue-900/5"
			style={{ opacity: 1, filter: 'blur(0px)' }}
		>
			{/* Corner decorations */}
			<div className="absolute z-10 size-2 rotate-45 rounded-[1px] border border-blue-200 dark:border-blue-300/25 bg-white dark:bg-black bottom-[-4.5px] left-[-4.5px]" />
			<div className="absolute z-10 size-2 rotate-45 rounded-[1px] border border-blue-200 dark:border-blue-300/25 bg-white dark:bg-black right-[-4.5px] bottom-[-4.5px]" />
