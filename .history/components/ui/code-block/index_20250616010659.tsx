...
import { CopyButton } from '@/components/animate-ui/copy'
...
export type CodeBlockCopyButtonProps = ComponentProps<typeof CopyButton> & {
	onCopy?: () => void
	timeout?: number
}
...
export const CodeBlockCopyButton = ({
	...
	const code = value ? data.find((item) => item.language === value)?.code : ''
