			...
			<div className="space-y-4 group-data-[collapsible=icon]:hidden">
				...
				<div className="relative">
					...
					<div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center gap-1">
						<Kbd className="bg-primary h-5 max-w-max rounded-xs px-1.5 flex items-center gap-0.5 text-[.6875rem] font-bold  dark:text-gray-300 dark:border-offgray-400/10 border  dark:bg-cream-900/10   sm:flex !border-white/20 dark:!bg-white/10 ">
							<KbdKey aria-label="Meta">⌘</KbdKey>
							<KbdKey>K</KbdKey>
						</Kbd>
					</div>
