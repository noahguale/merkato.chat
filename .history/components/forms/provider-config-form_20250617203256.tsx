					...
					render={({ field }) => (
						<FormItem>
							...
							>
								...
								<TabsContent value="google" className="min-h-[500px] w-full">
								...
								<TabsContent value="anthropic" className="min-h-[200px]">
									{renderProviderContent(
										'anthropic',
										'Anthropic',
								...
								<TabsContent value="openai" className="min-h-[200px]">
									{renderProviderContent(
										'openai',
										'OpenAI',
								...
								<TabsContent value="openrouter" className="min-h-[200px]">
									{renderProviderContent(
										'openrouter',
										'OpenRouter',
