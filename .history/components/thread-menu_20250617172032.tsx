...
export function ThreadMenu({
	...
	return (
		<CommandMenu
			...
			// Remove automatic keyboard shortcut - will be handled globally
		/>
	)
}

// Global Thread Menu with ⌘K shortcut
export function GlobalThreadMenu() {
	...
	// Global ⌘K shortcut for thread search
	React.useEffect(() => {
	...
	// Only render when open to avoid showing trigger button
	if (!open) return null
	...
	return (
		<SimpleCommandMenu
			...
			onItemSelect={(item) => {
				console.log('Selected thread:', item.threadData)
			}}
		/>
	)
}
