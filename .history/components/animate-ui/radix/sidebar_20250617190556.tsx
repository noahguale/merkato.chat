...
function SidebarRail({ className, ...props }: SidebarRailProps) {
	...
	return (
		<button
			...
			{...props}
		>
			<div className="absolute z-10 size-2 rotate-45 rounded-[1px] border border-blue-200 dark:border-blue-300/25 bg-white dark:bg-black top-0 right-0" />
			<div className="absolute z-10 size-2 rotate-45 rounded-[1px] border border-blue-200 dark:border-blue-300/25 bg-white dark:bg-black bottom-0 right-0" />
		</button>
	)
}
